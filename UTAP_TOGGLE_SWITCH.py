...
def sensor_read(arg1):
    while True:
        ...
        try:
            ...
            heading = 57.2958*yaw_tilt#convert to degrees
        ...
        xx = round(math.cos(yaw_tilt-math.pi/2)*23)
        yy = round(math.sin(yaw_tilt-math.pi/2)*23)
        ...
        draw.text((0,-2),"Yaw: {}".format(round(heading)),font=font,fill=255)
    ...
    while True:
        ...
        if evbuf:
            ...
            if upTrigger:
                ...
                pwm.channels[OR1_PWM].duty_cycle = intValrx
                pwm.channels[GR2_PWM].duty_cycle = 0
              
            elif intValry:
                GPIO.output(OR1,GPIO.HIGH)#direction pin

                pwm.channels[OR1_PWM].duty_cycle = intValry
                pwm.channels[GR2_PWM].duty_cycle = 0
